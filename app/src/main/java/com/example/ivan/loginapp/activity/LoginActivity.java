...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_sign.setTextColor(Color.parseColor("#2292E4"));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Variables.setIdRole(user.getRole().getIdRole());
                if (user.getRole().getIdRole()==3){
                    Variables.setIdDirection(user.getDirection().getIdDirection());
                }
                Variables.setFIO(user.getRole().getRoleName()+"\n"+"\n"+user.getFio());
                Variables.setIdRole(user.getRole().getIdRole());
                Variables.setUserLogin(user.getLogin());
                Variables.setIdUser(user.getIdUser());
